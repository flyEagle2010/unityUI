#if (FEATSERVICEMODEL && PLATXMLSERIALIZER) || (SILVERLIGHT && !PHONE7)
using System.IO;
...
namespace ProtoBuf.ServiceModel
{
    ...
    public sealed class XmlProtoSerializer : XmlObjectSerializer
    {
        ...
        {
            if (writer == null) throw new ArgumentNullException("writer");
            writer.WriteStartElement(PROTOELEMENT);
        }
        private const string PROTOELEMENT = "proto";
        /// <summary>
        ...
        public override bool IsStartObject(System.Xml.XmlDictionaryReader reader)
        {
            ...
            return reader.NodeType == System.Xml.XmlNodeType.Element && reader.Name == PROTOELEMENT;
        }
        ...
        public override object ReadObject(System.Xml.XmlDictionaryReader reader, bool verifyObjectName)
        {
            ...
            reader.ReadStartElement(PROTOELEMENT);
            ...
            if(isSelfClosed) // no real content
            {
                ...
                try
                {
                    protoReader = ProtoReader.Create(Stream.Null, model, null, ProtoReader.TOEOF);
            ...
            using (MemoryStream ms = new MemoryStream(reader.ReadContentAsBase64()))
            {
                ...
                else
                {
                    ...
                    try
                    {
                        protoReader = ProtoReader.Create(ms, model, null, ProtoReader.TOEOF);
