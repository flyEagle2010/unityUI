...
namespace ProtoBuf.Meta
{
    ...
    public abstract class TypeModel
    {
        ...
        public object Deserialize(Stream source, object value, System.Type type, SerializationContext context)
        {
            ...
            try
            {
                reader = ProtoReader.Create(source, this, context, ProtoReader.TOEOF);
        ...
        public object DeepClone(object value)
        {
            ...
            if (key >= 0 && !Helpers.IsEnum(type))
            {
                using (MemoryStream ms = new MemoryStream())
                {
                    ...
                    try
                    {
                        reader = ProtoReader.Create(ms, this, null, ProtoReader.TOEOF);
...
#if PLATBINARYFORMATTER && !(WINRT || PHONE8)
        /// <summary>
