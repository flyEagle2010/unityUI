...
namespace ProtoBuf.Meta
{
    internal abstract class AttributeMap
    {
        ...
        public static AttributeMap[] Create(TypeModel model, Type type, bool inherit)
        {
            ...
            System.Collections.Generic.IList<CustomAttributeData> all = type.GetCustomAttributes(attribType, inherit);
        ...
        {
#if FEATIKVM
            System.Collections.Generic.IList<CustomAttributeData> all = member.GetCustomAttributes(model.MapType(typeof(Attribute)), inherit);
            AttributeMap[] result = new AttributeMap[all.Count];
            int index = 0;
            foreach (CustomAttributeData attrib in all)
            {
        ...
        public static AttributeMap[] Create(TypeModel model, Assembly assembly)
        {
            ...
            System.Collections.Generic.IList<CustomAttributeData> all = assembly.GetCustomAttributes(model.MapType(typeof(Attribute)), inherit);
            AttributeMap[] result = new AttributeMap[all.Count];
            int index = 0;
            foreach (CustomAttributeData attrib in all)
            {
