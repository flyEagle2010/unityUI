...
namespace ProtoBuf.Serializers
{
    sealed class ListDecorator : ProtoDecoratorBase
    {
        ...
        private bool IsList { get { return (options & OPTIONSIsList) != 0; } }
        private bool SuppressIList { get { return (options & OPTIONSSuppressIList) != 0; } }
        private bool WritePacked { get { return (options & OPTIONSWritePacked) != 0; } }
        private bool SupportNull { get { return (options & OPTIONSSupportNull) != 0; } }
        private bool ReturnList { get { return (options & OPTIONSReturnList) != 0; } }
        ...
        public ListDecorator(TypeModel model, Type declaredType, Type concreteType, IProtoSerializer tail, int fieldNumber, bool writePacked, WireType packedWireType, bool returnList, bool overwriteList, bool supportNull)
            : base(tail)
        {
            if (returnList) options |= OPTIONSReturnList;
            if (overwriteList) options |= OPTIONSOverwriteList;
            if (supportNull) options |= OPTIONSSupportNull;
            ...
            if (writePacked) options |= OPTIONSWritePacked;
        ...
        {
            get { return (options & OPTIONSOverwriteList) == 0; }
        }
