...
#if FEATIKVM // in IKVM, we'll have the default value as an underlying type
        ...
        private void EmitBeq(Compiler.CompilerContext ctx, Compiler.CodeLabel label, Type type)
        {
            switch (Helpers.GetTypeCode(type))
            {
                ...
                case ProtoTypeCode.UInt64:
                    ...
                    break;
                default:
                    MethodInfo method = type.GetMethod("opEquality", BindingFlags.Public | BindingFlags.Static,
